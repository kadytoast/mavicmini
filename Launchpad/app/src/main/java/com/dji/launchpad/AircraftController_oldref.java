...
public class AircraftController_oldref extends Activity implements View.OnClickListener {

    private static final String TAG = AircraftController_oldref.class.getName();
    ...
    public void showToast(final String msg) {
        runOnUiThread(new Runnable() {
            public void run() {
                Toast.makeText(AircraftController_oldref.this, msg, Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void initUI() {
        ...
        mTextView = (TextView) findViewById(R.id.textview_position);
        mConnectStatusTextView = (TextView) findViewById(R.id.ConnectStatusTextView);
        mBtnHome = (Button) findViewById(R.id.btn_set_home);
